...
class WorkLevelLayout extends Component {
  ...
  onSelect = (selectedKeys,e) => {
    ...
    router.push({
      pathname:'/statistics/workLevel/workLevelLayout/show',
...
export default WorkLevelLayout;
