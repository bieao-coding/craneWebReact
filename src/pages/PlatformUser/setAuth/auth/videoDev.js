...
@connect(({ platformUser, loading }) => ({
  platformUser,
  loading: loading.effects['platformUser/getVideoDev'],
}))
class VideoDev extends Component {
  state = {
    list:[],
    selectedRowKeys:[],
    saveLoading:false,
  ...
  requestParentSelect(params){
    ...
    dispatch({
      type: 'platformUser/getSelectVideoDev',
  ...
  save = () => {
    ...
    dispatch({
      type: 'platformUser/saveVideoDev',
