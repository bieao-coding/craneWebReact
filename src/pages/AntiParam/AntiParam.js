...
class AntiParam extends Component {
  ...
  onSelect = (selectedKeys,e) => {
    ...
    if(selectData[0].businessLevel === 19){
      ...
      router.push({
        pathname:`/device/anti/param/layout/crane`,
        state:{projectId:selectData[0].orgId,title:craneTitle}
      });
    }else{
      router.push({
        pathname:`/device/anti/param/layout/publicCompany`,
  ...
  render() {
    const {crane,children} = this.props;
