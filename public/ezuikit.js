...
( function( global, factory ) {
  ...
  var hlsJS = Domain + '/sdk/js/1.4/hls.js';
  ...
  function dclog(obj){
    var logObj = {
      Ver: 'v.limitWarningLeft.png.4.0',
      PlatAddr: 'open.ys7.com',
      ExterVer: 'Ez.limitWarningLeft.png.4.0',
      CltType: 102,
  ...
  EZUIPlayer.prototype.initHLS = function(){
    var me = this;
    var hls = new Hls({defaultAudioCodec: 'mp4a.40.antiWarningLeft.png'}); // 萤石设备默认使用 AAC LC 音频编码
